...
SRCS =	ft_atoi.c, ft_bzero.c, ft_isalnum.c, ft_isalpha.c \
		...
		ft_isspace.c, ft_isupper.c, ft_itoa.c, ft_memalloc.c \
		ft_memccpy.c, ft_memchr.c, ft_memcmp.c, ft_memcpy.c \
		ft_memdel.c, ft_memmove.c, ft_memset.c, ft_putchar_fd.c \
		ft_putchar.c, ft_putendl_fd.c, ft_putendl.c, ft_putnbr_fd \
		ft_putnbr.c, ft_putstr_fd.c, ft_putstr.c, ft_strcat.c \
...
OBJS = ft_atoi.o, ft_bzero.o, ft_isalnum.o, ft_isalpha.o \
		...
		ft_isspace.o, ft_isupper.o, ft_itoa.o, ft_memalloc.o \
		ft_memccpy.o, ft_memchr.o, ft_memcmp.o, ft_memcpy.o \
		ft_memdel.o, ft_memmove.o, ft_memset.o, ft_putchar_fd.o \
		ft_putchar.o, ft_putendl_fd.o, ft_putendl.o, ft_putnbr_fd \
		ft_putnbr.o, ft_putstr_fd.o, ft_putstr.o, ft_strcat.o \
		...
		ft_strtrim.o, ft_tolower.o, ft_toupper.o, ft_lstnew.o \
